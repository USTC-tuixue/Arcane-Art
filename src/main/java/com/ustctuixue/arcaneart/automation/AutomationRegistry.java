...
public class AutomationRegistry {
    ...
    public static RegistryObject<Block> FROZEN_CRYSTAL_BLOCK = BLOCK_TYPE_DEFERRED_REGISTER.register("frozen_crystal", SolarCrystal::new);
    public static RegistryObject<Block> MAGMA_CRYSTAL_BLOCK = BLOCK_TYPE_DEFERRED_REGISTER.register("magma_crystal", SolarCrystal::new);
