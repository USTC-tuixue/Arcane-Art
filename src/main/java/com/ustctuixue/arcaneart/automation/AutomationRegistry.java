...
public class AutomationRegistry {
    ...
    public static RegistryObject<Block> COLLECTIVE_CRYSTAL_BLOCK = BLOCK_TYPE_DEFERRED_REGISTER.register("collective_crystal", () -> {
    ...
    public static RegistryObject<Item> COLLECTIVE_CRYSTAL_ITEM = ITEM_TYPE_DEFERRED_REGISTER.register("collective_crystal", () -> {
        return new BlockItem(AutomationRegistry.COLLECTIVE_CRYSTAL_BLOCK.get(), new Item.Properties().group(ArcaneArt.ARCANE_ART_ITEM_GROUP));
    });
    ...
    public static RegistryObject<TileEntityType<CollectiveCrystalTileEntity>> collectiveCrystalTileEntity = TILE_ENTITY_TYPE_DEFERRED_REGISTER.register("collective_crystal_tileentity", () -> {
        ...
        }, AutomationRegistry.COLLECTIVE_CRYSTAL_BLOCK.get()).build(null);
    });
}
