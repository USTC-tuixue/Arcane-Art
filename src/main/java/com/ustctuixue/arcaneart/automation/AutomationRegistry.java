...
public class AutomationRegistry {
    ...
    public static RegistryObject<Block> COLLECTIVE_CRYSTAL_BLOCK = BLOCK_TYPE_DEFERRED_REGISTER.register("collective_crystal", CollectiveCrystal::new);
    ...
    public static RegistryObject<TileEntityType<CollectiveCrystalTileEntity>> COLLECTIVE_CRYSTAL_TILEENTITY = TILE_ENTITY_TYPE_DEFERRED_REGISTER.register("collective_crystal_tileentity", () -> TileEntityType.Builder.create(CollectiveCrystalTileEntity::new, AutomationRegistry.COLLECTIVE_CRYSTAL_BLOCK.get()).build(null));
