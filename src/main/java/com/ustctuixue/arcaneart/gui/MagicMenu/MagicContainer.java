...
public class MagicContainer extends Container
{
    ...
    public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, PlayerEntity player)
    {
        ...
        if (slotId >= 0)
        {
            ...
            if (!(pickedItemStack.isEmpty() || pickedItemStack.getItem() instanceof ItemSpell || pickedItemStack.getItem() == Items.WRITTEN_BOOK))
            {
                return ItemStack.EMPTY;
            }
    ...
    {
        return slotIn.inventory != spellMainInventory && slotIn.inventory != spellHotBar && slotIn.inventory != bookIcon && slotIn.inventory != deleteIcon;
    }
